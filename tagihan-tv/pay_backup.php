<?php
@ob_start(); // buffer semua output sebelum require (mencegah "headers already sent")
error_reporting(E_ERROR | E_PARSE); // mute notices/warnings/deprecated agar tidak output sebelum session
...
if (isset($_REQUEST['msg'], $_REQUEST['csrf'])) {
    ...
    if ($_SESSION['csrf'] === $csrf) {
        if ($msg === "cek") {
            ...
            $cek_tagihan_http = CallApiV2($param, "https://api-v2.bukakios.net/wv-x7Up2p/pasca/inq");
            ...
            if (isset($_REQUEST['inq_id'], $_REQUEST['trx_id'], $_REQUEST['biaya_toko'])) {
                ...
                $bayar_tagihan_http = CallApiV2($param, "https://api-v2.bukakios.net/wv-x7Up2p/pasca/pay");
...
if (isset($data_produk['status']) and $data_produk['status'] == 1) {
    ...
    $html_title = "Gagal";
    $lyt_button_link = "$c_url/tagihan-internet/";
    ...
    <div class="container" style="margin-bottom:60px;">
        <div class="row ">
            <div class="py-3 mx-auto col-md-10">
                <span class="font-weight-bold">Masukan No Pelanggan</span>
                <div class="row mt-2">
                    <div class="col-12">
                        <input type="number" id="nope" class="form-control" placeholder="Masukan No Pelanggan" required>
                ...
                <div id="infome">
                    <div class="alert alert-success text-justify" style="margin-top:10px">
                        ...
                        <a href="index.php" class="btn btn-block btn-sm btn-danger">Ganti Provider</a>
                    </div>
