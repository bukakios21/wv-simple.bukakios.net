  ...
  <script>
    ...
    function showInfo() {
      showModal({
        ...
        message: 'Nomor pelanggan Internet tertera pada kartu pelanggan, struk, atau invoice bulanan dari ISP terkait. Biasanya berupa angka 8–18 digit. Jika kesulitan, hubungi provider Internet terdekat.',
        variant: 'info',
        btnText: 'Ok'
      });
    }
    ...
    function renderDetail(data) {
      ...
      // Field khusus Internet (fallback ke '-' jika kosong)
