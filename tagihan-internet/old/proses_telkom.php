...
if($act=='cek'){
	...
	if(isset($_GET['id_pelanggan'],$_GET['csrf'])){
		...
		if(isset($_SESSION[$session_cache])){
            ...
            //logic untuk custom profit
           if (isset($_GET['biaya_profit'])){
                $biaya_profit = abs((int) $_GET['biaya_profit']);
                $datanya['data']['admin_user'] =  $biaya_profit;
           }
