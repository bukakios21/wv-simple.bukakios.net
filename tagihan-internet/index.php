...
// if ($user_id == 278542) {
//      header("Location: https://wv3.bukakios.id/tagihan-internet");
//         exit();
// }
...
<head>
    ...
    <title>title::Bayar Tagihan Internet</title>
    <style>
        .search {
            position: relative;
            /* color: #aaa; */
...
<body>
    <div style="background-color:<?= $primary ?>;">
        <div class="mx-auto py-5 mb-2 text-center">
            <img width="64px" src="https://assets2.bukakios.net/img2/uploads/2025/04/156-wifi-router-white-logo.png">
            <p>
            <h5 style="color:white">Tagihan Internet</h5>
            </p>
        </div>
    </div>
    <div class="container">
        ...
        <div id="data">
            <div class="list-group list-group-flush mt-3">
                <?php
                $lists = $app->curl_post("$api_url/v1/api_detail_produk.php", ['key' => $api_key, "id" => 140]);
                ...
                ?>
                        <li class="list-group-item">
					     ...
					     <a href="pay.php?code=<?PHP  echo $list['code']; ?>&wv_3=<?php echo $wv_3; ?>&id_produk=<?php echo $list['id_produk']; ?>&nama_produk=<?php echo $list['product_name']; ?>">
                                            <?php
                                                if ($list['product_img'] != "") {?>
                                            ...
                                            ?>
                                                <img src="<?PHP echo "https://assets.bukakios.net/img/icon/produk-by-id/$list[id_produk].png"; ?>" width="40px;">
                                            <?php
                                                }
                                            ?>
