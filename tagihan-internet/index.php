...
/************ LOAD PRODUCTS (SSR) ************/
// pembelianoperator_id untuk produk Internet Pascabayar (sesuai referensi legacy id=140)
$operator_id = 140;
...
<head>
  ...
  <title>BukaKios - Tagihan Internet Pascabayar</title>
...
<body class="min-h-screen bg-white font-sans text-slate-950">
  ...
  <main class="relative w-full min-h-screen bg-slate-50 pb-24">
    ...
    <section class="px-6 pt-5 pb-4 bg-white">
      <div class="flex items-center gap-3">
        <div class="flex h-12 w-12 items-center justify-center rounded-2xl shadow-card bg-brand/8 overflow-hidden">
          <!-- Wifi router icon (default fallback) -->
    ...
    <section class="px-4 pb-8">
      <?php if (count($products) > 0): ?>
        ...
        <!-- Product cards -->
        <div id="internetList" class="flex flex-col gap-2">
            ...
            >
              ...
              <div class="h-11 w-11 flex items-center justify-center rounded-xl bg-slate-100 overflow-hidden shrink-0">
                <img
                  ...
                  loading="lazy"
                  onerror="this.style.display='none';this.parentElement.innerHTML='<svg class=\'h-6 w-6 text-brand\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'currentColor\' stroke-width=\'1.8\'><path d=\'M5 12.55a11 11 0 0114 0\'/><path d=\'M1.42 9a16 16 0 0121.16 0\'/><path d=\'M8.53 16.11a6 6 0 016.95 0\'/><line x1=\'12\' y1=\'20\' x2=\'12.01\' y2=\'20\'/></svg>'"
                />
              </div>
  ...
  <script>
    ...
    // Live filter untuk daftar Internet
    function filterInternet(q) {
      var list   = document.getElementById('internetList');
