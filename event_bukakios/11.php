...
$winner_utama = array(
    array(
        'nama' => "Avlyn cell",
        "email" => "andiariscell@gmail.com",
        "rata" => "74",
    ),
    array(
        'nama' => "Jay Ponsel 2",
        "email" => "ramadaninadia30@gmail.com",
        "rata" => "29",
    ),
    array(
        'nama' => "Nabilah cell",
        "email" => "peisaputra1@gmail.com",
        "rata" => "36",
    ),
    array(
        'nama' => "Toko Mutia windani",
        "email" => "mutia4183@gmail.com",
        "rata" => "28",
    ),
    array(
        'nama' => "Mr.Ponsel",
        "email" => "ridhomr371@gmail.com",
        "rata" => "48",
    ),
);
...
<body>
    ...
    <div class="container" style="background-color:#fff">
        <table style="width:100%">
            <tr>
                ...
                <td rowspan="2">
                    <img class="img-child" src="https://assets.bukakios.net/img2/uploads/2022/07/33-baki-cover-app.png" width="30px">
                </td>
    ...
    <!-- <div class="body"> -->
    <div class="container">
        <span class="text-muted title-child">Daftar Pemenang Event BAKI Periode 2</span>
        <hr>
        <?php
        $no = 1;
        $utama_ni = '';
