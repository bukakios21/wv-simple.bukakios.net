...
$data_user = $app->grab_data("$api_url/_event/pemenang.php?key=$api_key&periode=04-2022&uid=$user_id&page=1&limit=50");
...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="alert alert-primary">
            Data ranking di update secara realtime, poin yang di hitung hanya poin yang kamu kumpulkan di bulan maret 2022 saja ya
        </div>
        <hr />
