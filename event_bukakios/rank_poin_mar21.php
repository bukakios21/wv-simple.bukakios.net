...
$data_user = $app->grab_data("$api_url/_event/pemenang.php?key=$api_key&periode=06-2021&uid=$user_id&page=1&limit=50");
...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="alert alert-primary">
            Data ranking di update secara realtime, poin yang di hitung hanya poin yang kamu kumpulkan di bulan juni 2021 saja ya
        </div>
        <hr />
