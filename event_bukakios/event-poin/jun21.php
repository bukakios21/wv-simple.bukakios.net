...
$data_user = $app->grab_data("$api_url/_event/pemenang.php?key=$api_key&periode=06-2021&uid=$user_id");
...
<div class="container">
    ...
    <div class="container">
        ...
        <div class="alert alert-primary">
            Data ranking di update secara realtime, poin yang di hitung hanya poin yang kamu kumpulkan di bulan maret saja ya
        </div>
        <hr />
        ...
        <hr />
        <strong style="font-size:20px">Ranking 1 - 20</strong>
        <hr />
    </div>
    <div class="mt-3">
        <div class="container">
