...
require_once(ROOT . "/lib/ApiV2.php");
$apiv2 = new ApiV2();
$body = array(
    'start' => "2023-03-23",
    'end' => "2023-04-24",
);
$res = $apiv2->get_poin_by_tanggal($body);
// echo $res;
$app->simpan_file("e-2023.txt", $res);
...
<head>
    ...
    <title>title::Ranking sementara</title>
    <style>
        /* body {
                                        ...
                                        <td colspan="2">
                                            <div class="progress" style="height: 8px;">
                                                <div class="progress-bar" role="progressbar" style="width: <?php //echo $progress 
                                                                                                            ?>%;<?php echo $style ?>" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </td>
                                    </tr>
                            <?php
