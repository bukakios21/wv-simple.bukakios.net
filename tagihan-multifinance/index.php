  ...
  <main class="relative w-full min-h-screen bg-slate-50 pb-24">
    ...
    <section class="px-6 pt-5 pb-4 bg-white">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h1 class="text-[17px] font-bold text-slate-900 leading-tight">Angsuran Multifinance</h1>
          <p class="text-[12px] text-mutedText mt-0.5">Pilih finance untuk membayar angsuran</p>
        </div>
      </div>
    </section>
    ...
    <section class="px-4 pb-8">
      <?php if (count($products) > 0): ?>
        ...
        <div class="flex items-center gap-2 mb-3 px-1">
          <span class="text-[11px] font-semibold text-mutedText uppercase tracking-wide">Daftar Multifinance</span>
        ...
        <div id="emptySearch" class="hidden mt-6 flex flex-col items-center gap-3 text-center px-4">
          ...
          <div>
            <p class="text-[14px] font-semibold text-slate-700">Finance tidak ditemukan</p>
            <p class="text-[12px] text-mutedText mt-1">Coba kata kunci lain, misalnya nama finance.</p>
          </div>
        </div>
      ...
      <?php else: ?>
        ...
        <div class="mt-10 flex flex-col items-center gap-3 text-center px-4">
          ...
          <div>
            <p class="text-[14px] font-semibold text-slate-700">Gagal memuat daftar Multifinance</p>
