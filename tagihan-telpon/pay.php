    ...
    <section class="px-4 pb-4">
      <div class="rounded-[16px] border border-slate-200 bg-white shadow-soft overflow-hidden">
        <div class="px-5 pt-5 pb-4" id="inputSection">
          <label class="text-[13px] font-semibold text-slate-700">Nomor Telepon / ID Tagihan</label>
          ...
          <p class="text-[12px] text-mutedText mt-2">Masukkan nomor telepon <?= htmlspecialchars($product_name) ?></p>
        </div>
          ...
          <div class="rounded-xl bg-emerald-50 border border-emerald-100 px-4 py-3 flex items-start gap-3">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-[12px] text-emerald-700 leading-snug">
                Bayar tagihan telepon <?= htmlspecialchars($product_name) ?> di bukakios, kamu otomatis mendapatkan keuntungan dari biaya admin.
              </p>
            </div>
  ...
  <script>
    ...
    function showInfo() {
      showModal({
        ...
        message: 'Nomor telepon tertera pada tagihan atau invoice bulanan dari operator telepon terkait. Masukkan nomor tanpa spasi atau tanda hubung. Jika kesulitan, hubungi layanan pelanggan operator terkait.',
        variant: 'info',
        btnText: 'Ok'
      });
    }
    ...
    function doCek() {
      ...
      if (!id_pelanggan) {
        showToastError('Nomor telepon tidak boleh kosong');
    ...
    function renderDetail(data) {
      ...
      // Field khusus Telepon (fallback ke '-' jika kosong)
