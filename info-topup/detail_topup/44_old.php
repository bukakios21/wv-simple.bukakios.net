...
<div class="mt-2 mb-1">
    <?PHP echo "Silahkan lakukan transfer pulsa sebesar <b>$total_transfer</b> ke nomor <b>$nom_rek</b> dengan cara lakukan dialup/panggilan ke nomor di bawah ini :"; ?>
</div>
<div class="mt-1 py-3 px-4 text-center" style="border: 3px dashed #9C9C9C">
    <div id='cara-bayar-id-1' class="mt-1">
        <?PHP
        $fomat_dial = "*323*1*$nom_rek*$total_transfer#";
        $fomat_dial_link = str_replace("#", "%23", $fomat_dial);
        ?>
        <span id='query_text' style="font-weight:bold" data-text="Berhasil Salin " data-copy="<?PHP echo $fomat_dial; ?>">
            <?PHP echo $fomat_dial; ?></span>
        <a class="btn btn-sm btn-outline-primary" onclick="copyToClipboard('query_text')"><i class="fa fa-copy"></i></a>
        <br />
        Atau
        <br />
        <a class="btn btn-sm btn-outline-primary" href="tel:<?PHP echo $fomat_dial_link; ?>"><i class="fa fa-phone-alt"></i> Transfer Pulsa Sekarang</a>
    </div>
</div>
