			...
			<div id='info-bank' class="text-center">
				<!-- <div class='col-md-6 col-xs-12 mx-auto'> -->
					<div class='box' style='padding:20px;cursor:default'>
						...
						<b>Institusi Multipayment : I-Pay (87796)</b><br>
...
<div id='panduanbayar'>
	<div class="pl-16 pr-16 pt-24">
		...
		<div id="accordion">
						...
						<div class='row'>
							<div class="col-md-12 col-sm-12">
								<ol style='padding-left:10px;padding-right:10px'>
									...
									<li>Pilih “Lainnya” 2x</li>
									<li>Pilih “Multi Payment”</li>
									<li>Masukkan (87827 atau 87796) sebagai Kode Perusahaan / Institusi</li>
									<li>Masukkan Nomor Virtual Account, <b><?PHP echo $nomor_rekening; ?></b> sebagai Nomor VA</li>
									<li>Pilih “Benar”</li>
									<li>Masukkan jumlah transfer sesuai dengan tagihan kamu. Jumlah yang berbeda tidak dapat diproses</li>
									<li>Pilih “Benar”</li>
									<li>Layar menampilkan Kode Bayar dan Data Pembayaran, lalu tekan “1” jika datanya benar</li>
						...
						<div class='row'>
							<div class="col-md-12 col-sm-12">
								<ol style='padding-left:10px;padding-right:10px'>
									...
									<li>Cari (87827 atau 87796) atau cari (LINKQU atau LINKQU-BILL) sebagai Penyedia Jasa</li>
									<li>Masukkan Nomor Virtual Account, <b><?PHP echo $nomor_rekening; ?></b></li>
									<li>Pilih Lanjutkan</li>
									<li>Masukkan jumlah transfer sesuai dengan tagihan kamu. Jumlah yang berbeda tidak dapat diproses</li>
									<li>Layar menampilkan Kode Bayar dan Data Pembayaran</li>
									<li>Jika datanya benar, Klik Lanjutkan</li>
									<li>Masukkan PIN New Livin, Klik OK</li>
									<li>Pembayaran selesai</li>

                                    <!-- <li>Login Mobile Banking</li>
                                    <li>Pilih Bayar</li>
                                    <li>Input 70017 (I-PAY) sebagai Penyedia jasa</li>
                                    <li>Input Nomor Virtual Account , misal 146XXXXXXXXXXX</li>
                                    <li>Pilih Lanjut</li>
			...
			<div class="card" style='margin-top:0px'>
				<div style='cursor:pointer' class="card-header" id="headingTwo" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
					<h5 class="mb-0">
						<a>
				...
				<div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
					<div class="card-body">
						<div class='row'>
							<div class="col-md-12 col-sm-12">
								<ol style='padding-left:10px;padding-right:10px'>
									<li>Masuk ke Internet Banking</li>
									<li>Pilih Bayar</li>
									<li>Pilih Multi Payment</li>
									<li>Cari (LINKQU atau LINKQU-BILL) sebagai Penyedia Jasa</li>
									<li>Masukkan Nomor Virtual Account, <b><?PHP echo $nomor_rekening; ?></b></li>
									<li>Klik Lanjutkan</li>
									<li>Masukkan jumlah transfer sesuai dengan tagihan kamu. Jumlah yang berbeda tidak dapat diproses</li>
									<li>Centang IDR</li>
									<li>Klik Lanjutkan</li>
									<li>Masukkan Kode dari Token Mandiri, lalu klik Kirim</li>
									<li>Tampilan struk pembayaran</li>
									<li>Pembayaran selesai</li>
								</ol>
							</div>
						</div>
						...
						<div class='row'>
							<div class="col-md-12 col-sm-12">
								<ol style='padding-left:10px;padding-right:10px'>
									...
									<li>Masukkan kode (87827 atau 87796) + Nomor Virtual Account, <b><?PHP echo $nomor_rekening; ?></b></li>
									<li>Masukkan jumlah transfer sesuai dengan tagihan kamu. Jumlah yang berbeda tidak dapat diproses</li>
									<li>Ikuti langkah hingga Pembayaran selesai</li>
								</ol>
							</div>
						</div>
					</div>
