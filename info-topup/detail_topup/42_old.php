...
<div class="mt-1 py-3 px-4 text-center" style="border: 3px dashed #9C9C9C">
    <div id='cara-bayar-id-1' class="mt-1">
        <span id='query_text' style="font-weight:bold" data-text="Berhasil Salin " data-copy="*858*<?php echo $nom_rek ?>*<?php echo $total_transfer ?>#">*858*<?php echo $nom_rek ?>*<?php echo $total_transfer ?>#</span>
        <a class="btn btn-sm btn-outline-primary" onclick="copyToClipboard('query_text')"><i class="fa fa-copy"></i></a>
        <br />
        Atau
        <br />
        <a class="btn btn-sm btn-outline-primary" href="tel:*858*<?php echo $nom_rek ?>*<?php echo $total_transfer ?>%23"><i class="fa fa-phone-alt"></i>
            Transfer Pulsa Sekarang</a>
    </div>
</div>
