...
<div class='row'>
<div class='col-md-12'>
	<div id='infonya' class='card mt-3 bayar-id' style='margin-bottom:20px;padding:10px'>
	* <b>HARAP BACA</b> : Beritahu ke kasir mau bayar tagihan <b>LINKITA</b>, lalu tunjukan kode pembayaranya &rarr; <?PHP echo $nomor_rekening; ?> , biasanya saat di kasir ada biaya admin dari pihak alfamartnya sebesar Rp3.000
	</div>
</div>
</div>
						...
						<div class='row'>
							<div class="col-md-12 col-sm-12">
								<ol style='padding-left:10px;padding-right:10px'>
									...
									<li>Sebutkan untuk pembayaran tagihan <b>&quot;LINKITA&quot;</b></li>
									<li>Bayar Sesuai Tagihan di Bukakios Yakni : <b><?PHP echo $total_transfer_rp; ?></b> , biasanya ada biaya tambahan lagi sebesar <b>Rp3.000</b> dari pihak alfamart/alfamidi/dandan.</li>
