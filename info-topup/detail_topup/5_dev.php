...
$data_info = $app->curl_post("$api_url/get_topup_detail_dev.php",$data_post);
...
if(isset($data_info['status'])){
	...
	if($data_info['status']==1){
		...
		if(isset($data_info['payment_info'])){
            $payment_info = $data_info['payment_info']['data'];
...
?>
	...
	<div class='row'>
		<div class="col-12">
			<span class="font-weight-bold">Transfer Development</span>          
