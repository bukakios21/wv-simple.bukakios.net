...
$kode_produk = 'PGAS'; // kode produk PGN static
if (isset($_GET['code'])) {
...
<body class="min-h-screen bg-slate-50 font-sans text-slate-950">
    ...
    <section class="px-4 pb-4">
      <div class="rounded-[16px] border border-slate-200 bg-white shadow-soft overflow-hidden">
        <div class="px-5 pt-5 pb-4" id="inputSection">
          <label class="text-[14px] font-semibold text-slate-700">Nomor Pelanggan PGN</label>
          <div class="mt-2 flex gap-2">
            <input
              ...
              placeholder="Masukkan nomor pelanggan PGN"
              autocomplete="off"
            />
          ...
          <p class="text-[13px] text-mutedText mt-2">Masukkan nomor pelanggan gas PGN <?= htmlspecialchars($product_name) ?></p>
        </div>
  ...
  <script>
    ...
    function showInfo() {
      showModal({
        title: 'Cek Nomor Pelanggan PGN',
        message: 'Nomor pelanggan PGN tertera pada struk atau invoice bulanan gas. Biasanya berupa angka/kode pelanggan. Jika kesulitan, hubungi layanan PGN terkait.',
        variant: 'info',
        btnText: 'Ok'
      });
    }
    ...
    function renderDetail(data) {
      ...
      // Field khusus PGN/Pascabayar (fallback ke '-' jika kosong)
      ...
      // Sembunyikan baris meter_awal / meter_akhir kalau kosong
      if (meterAwal === '-') {
