...
if (isset($_REQUEST['msg'], $_REQUEST['csrf'])) {
    ...
    if ($_SESSION['csrf'] === $csrf) {
        if ($msg === "cek") {
            ...
            $app->simpan_file("cek-$code.json", $cek_tagihan_http);
            //************************** API V2 ***************************/
            ...
            if (isset($_REQUEST['inq_id'], $_REQUEST['trx_id'], $_REQUEST['biaya_toko'])) {
                ...
                $app->simpan_file("bayar-$code.json", $bayar_tagihan_http);
                //**************************** API V2 ********************************/
...
<body class="bdy">
    <div style="background-color:<?= $primary ?>;">
        <div class="mx-auto py-5 mb-2 text-center">
            <img src="https://assets.bukakios.net/img2/uploads/2021/06/310-fire.png">
        </div>
    </div>
    <div class="container" style="margin-bottom:60px;">
        <div class="row ">
            <div class="py-3 mx-auto col-md-10">
                <span class="font-weight-bold">No. Pelanggan / Tagihan</span>
                <div class="row mt-2">
                    <div class="col-12">
                    ...
                    <div>
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td height="10px"><span style="float:right;font-size:10px" id="nama"></span></td>
                            </tr>
                            <tr>
                                <td width="55%%" height="10px">Alamat</td>
                                <td height="10px"><span style="float:right;" id="alamat">-</span></td>
                            </tr>
                            <tr>
