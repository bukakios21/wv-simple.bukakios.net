...
<body class="min-h-screen bg-slate-50 font-sans text-slate-950 antialiased pb-8">
  ...
  <main class="px-4 pt-6">
    ...
    <div class="space-y-3 mb-6">
      ...
      <!-- WhatsApp -->
      <a href="<?php echo $open_url."https://api.whatsapp.com/send?phone=$wa_number"; ?>" target="_blank" class="flex items-center gap-4 w-full bg-white rounded-2xl border border-slate-100 p-4 shadow-card transition hover:shadow-md active:scale-[0.99]">
